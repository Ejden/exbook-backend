...
class ShippingValidator {
    ...
    fun validate(shippingMethod: ShippingMethod, selectedShippingRequest: CalculateSelectedShippingRequest) {
        validateAddressAndPickupPoint(shippingMethod, selectedShippingRequest)
    }

    private fun validateAddressAndPickupPoint(shippingMethod: ShippingMethod, selectedShippingRequest: CalculateSelectedShippingRequest) {
